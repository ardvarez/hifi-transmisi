...
# 1. Mode Catalog HTML (No bottom navbar, 2x2 catalog cards)
catalog_mode_html = """<!DOCTYPE html>
<html lang="id">

<head>
    <meta charset="UTF-8">
    <meta name="viewport" content="width=device-width, initial-scale=1.0, maximum-scale=1.0, user-scalable=no">
    <title>Dashboard ERS (Mode Catalog) - Mobile</title>
    <!-- Google Fonts -->
    ...
    <style>
        ...
        * {
        ...
        /* 3. KATALOG FITUR ERS (2X2 GRID CARDS) */
    ...
    <div class="mobile-container">
        ...
        <div class="header-section">
            <div class="header-left">
                ...
                <div class="header-titles">
                    ...
                    <span class="sub-title">Mode 1: Catalog View</span>
                </div>
            </div>
            <div class="header-actions">
                <a href="home-mobile-nav.html" class="mode-switch-pill" title="Pindah ke Mode 5 Navbar">
                    <i class="fa-solid fa-table-columns"></i> Ke Mode Nav
                </a>
        ...
        <div class="app-body">
            ...
            <div class="detail-section-card" id="detailSection">
                ...
                <div class="detail-item-list" id="detailDataList"></div>
...
# 2. Mode 5 Navbar HTML (With 5-tab Bottom Navigation: Dashboard, Pemasangan, Pembongkaran, Karantina, Stok Opname)
nav_mode_html = """<!DOCTYPE html>
<html lang="id">

<head>
    <meta charset="UTF-8">
    <meta name="viewport" content="width=device-width, initial-scale=1.0, maximum-scale=1.0, user-scalable=no">
    <title>Dashboard ERS (Mode 5 Navbar) - Mobile</title>
    <!-- Google Fonts -->
    <link href="https://fonts.googleapis.com/css2?family=Plus+Jakarta+Sans:wght@400;500;600;700;800&family=Outfit:wght@500;600;700;800&display=swap" rel="stylesheet">
    <!-- Font Awesome -->
    <link href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.4.0/css/all.min.css" rel="stylesheet">
    ...
    <style>
        ...
        * {
        ...
        /* ==================== 5-TAB BOTTOM NAVBAR (EXACT 5 TABS) ==================== */
        .bottom-nav-5tabs {
            position: absolute;
            bottom: 0;
            left: 0;
...
<body>
    ...
    <div class="mobile-container">
        ...
        <div class="header-section">
            <div class="header-left">
                ...
                <div class="header-titles">
                    <span class="header-badge-tag"><i class="fa-solid fa-bolt"></i> Server Development</span>
                    <h1 class="main-title">Dashboard ERS</h1>
                    <span class="sub-title">Mode 2: 5-Tab Navbar</span>
                </div>
            </div>
            <div class="header-actions">
                <a href="home-mobile.html" class="mode-switch-pill" title="Pindah ke Mode Catalog">
                    <i class="fa-solid fa-grip"></i> Ke Mode Catalog
                </a>
                <button class="header-icon-btn" onclick="openFilterModal()" id="btnFilterTrigger" title="Filter Wilayah & Data">
                    <i class="fa-solid fa-sliders"></i>
                </button>
        ...
        <div class="app-body">
            ...
            <!-- 1. SECTION HEADER: DATA KETERSEDIAAN -->
            <div class="section-header-block">
                <h2 class="section-title">Data Ketersediaan & Pemasangan</h2>
                <p class="section-subtitle">Menampilkan jumlah ERS berdasarkan ketersediaan dan pemasangan</p>
            </div>
            ...
            <!-- 4. CHART 1: ERS OPERASI PER UNIT -->
            <div class="chart-card-wrapper">
                <div class="chart-card-header">
                    <h3 class="chart-title">ERS Operasi Per Unit</h3>
                    <i class="fa-solid fa-chart-simple" style="color: #94a3b8; font-size: 13px;"></i>
            ...
            <!-- 5. CHART 2: SET ERS LENGKAP & TIDAK LENGKAP -->
            <div class="chart-card-wrapper">
                <div class="chart-card-header">
                    <h3 class="chart-title">Set ERS Lengkap & Tidak Lengkap</h3>
                    <i class="fa-solid fa-chart-column" style="color: #94a3b8; font-size: 13px;"></i>
            ...
            <!-- 6. CHART 3: DURASI ERS OPERASI (DONUT) -->
            <div class="chart-card-wrapper">
                <div class="chart-card-header">
                    <h3 class="chart-title">Durasi ERS Operasi</h3>
                    <i class="fa-solid fa-chart-pie" style="color: #94a3b8; font-size: 13px;"></i>
        ...
        <!-- 8. EXACT 5-TAB BOTTOM NAVBAR -->
        <nav class="bottom-nav-5tabs">
            <!-- 1. Dashboard (Active) -->
            <a href="home-mobile-nav.html" class="tab-5-item active" title="Dashboard Root">
                <i class="fa-solid fa-chart-pie"></i>
                <span>Dashboard</span>
            </a>

            <!-- 2. Pemasangan -->
            <a href="Pemasangan/home-mobile.html" class="tab-5-item" title="Pemasangan ERS">
                <i class="fa-solid fa-wrench"></i>
                <span>Pemasangan</span>
            </a>

            <!-- 3. Pembongkaran -->
            <a href="Pembongkaran/home-mobile.html" class="tab-5-item" title="Pembongkaran ERS">
                <i class="fa-solid fa-truck-ramp-box"></i>
                <span>Pembongkaran</span>
            </a>

            <!-- 4. Karantina -->
            <a href="Karantina & Pengembalian/home-mobile.html" class="tab-5-item" title="Karantina & Pengembalian">
                <i class="fa-solid fa-box-archive"></i>
                <span>Karantina</span>
            </a>

            <!-- 5. Stok Opname -->
            <a href="Stock Opname/home-mobile.html" class="tab-5-item" title="Stok Opname ERS">
                <i class="fa-solid fa-boxes-stacked"></i>
...
# Write File 1: Mode Catalog
file1 = r"c:\KERJAAN\Project\hifi-transmisi\hifi-mobile\ers\home-mobile.html"
with open(file1, "w", encoding="utf-8") as f:
    f.write(catalog_mode_html)
print(f"File 1 (Mode Catalog) written to {file1}")

# Write File 2: Mode 5 Navbar
file2 = r"c:\KERJAAN\Project\hifi-transmisi\hifi-mobile\ers\home-mobile-nav.html"
with open(file2, "w", encoding="utf-8") as f:
    f.write(nav_mode_html)
print(f"File 2 (Mode 5 Navbar) written to {file2}")
